 ...
 */
final class Version20250922173110 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql(<<<'SQL'
            CREATE TABLE captured_pokemon (id INT AUTO_INCREMENT NOT NULL, owner_id INT NOT NULL, pokemon_id INT NOT NULL, capture_date DATETIME NOT NULL, shiny TINYINT(1) NOT NULL, times_captured INT NOT NULL, quantity INT NOT NULL, INDEX IDX_C885E5D17E3C61F9 (owner_id), INDEX IDX_C885E5D12FE71C3E (pokemon_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE trade (id INT AUTO_INCREMENT NOT NULL, user1_id INT NOT NULL, user2_id INT NOT NULL, pokemon_trade1_id INT DEFAULT NULL, pokemon_trade2_id INT DEFAULT NULL, status INT NOT NULL, user1_status INT NOT NULL, user2_status INT NOT NULL, price INT DEFAULT NULL, INDEX IDX_7E1A436656AE248B (user1_id), INDEX IDX_7E1A4366441B8B65 (user2_id), INDEX IDX_7E1A4366AA3B8B7A (pokemon_trade1_id), INDEX IDX_7E1A4366B88E2494 (pokemon_trade2_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB
        SQL);
        $this->addSql(<<<'SQL'
